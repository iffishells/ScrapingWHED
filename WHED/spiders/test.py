...
print('starrted')
li = ['Afghanistan', 'Albania', 'Algeria', 'Andorra', 'Angola', 'Argentina', 'Armenia', 'Aruba', 'Australia', 'Austria', 'Azerbaijan']

json = [  { 'Afghanistan' : [ {'Univesity Name ': 'FAST NUCEs' ,
                        'University URL ': '....'} ]}  
                                     ]
new= []
print(new.append( {li[0] : 12}) )
# print(new)

# level_1 = {'uff' : [{'pakistan' : 'co',
#                                 '1' : 2} ] ,
#             } 
